...
#define LPS331AP_ADDRESS 0b1011100
#define LPS331AP_ADDRESS_V2 0b1011101
...
class LPS331 {
public:
    LPS331(uint8_t addr = LPS331AP_ADDRESS);
    ...
    static float pressureToAltitudeMeters(float pressure_mbar,
                                          ...
                                          = 1013.25);
    static float pressureToAltitudeFeet(float pressure_inHg,
